        ...
        >
            ...
            <button
                ...
                category.categoryId === selectedCategoryID
                    ? "border-sky-400"
                    : "border-gray-500"
                } rounded-full shadow-sm hover:opacity-90 focus:outline-none focus:ring-2 focus:ring-sky-600 focus:ring-offset-2 transition duration-200 ease-in-out transform hover:-translate-y-1 hover:scale-105`}
            >
